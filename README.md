...
1) eventually-consistent event threads via Textile  
2) Three.js for graphics and STL conversion (VR? AR?)
3) three-pillars map creation and use - combat, exploration, social
4) 3d physics dice (there's a library for dice expressions and one for physics dice)
